...
public class SinksManyMulticast {
    ...
    public static void main(String[] args) {
        Many<Integer> multicastSink = Sinks.many().multicast().onBackpressureBuffer(); // for only one subscriber
        ...
        fluxView.subscribe(data -> Log.onNext("Subscriber2", data)); // hot sequence, warm-up
